...
public final class KubeSkewerItemBuilder extends ItemBuilder {
  ...
  private void useGeneratedSkewerModel() {
    ...
    generated.addProperty("parent", "kaleidoscope_grilling:item/secret_skewer");
    modelJson = generated;
  }
    ...
    if (foodBuilder == null) {
      properties.food(
          new FoodProperties.Builder()
              .nutrition(raw ? 2 : 6)
              .saturationMod(raw ? 0.2F : 0.6F)
              .build());
    }
    return new KubeSkewerItem(
        properties, effect, effectSeconds * 20, animation, generatedModel);
  }
}
