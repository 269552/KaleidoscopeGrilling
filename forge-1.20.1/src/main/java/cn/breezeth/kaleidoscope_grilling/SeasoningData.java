...
public final class SeasoningData {
    ...
    public static int getVariant(ItemStack stack) { return stack.hasTag() ? net.minecraft.util.Mth.clamp(stack.getTag().getInt(VARIANT_KEY), 0, 7) : 0; }
    public static void setVariant(ItemStack stack, int variant) { stack.getOrCreateTag().putInt(VARIANT_KEY, net.minecraft.util.Mth.clamp(variant, 0, 7)); }
