...
public final class GrillLoopSound extends AbstractTickableSoundInstance {
    ...
    public static void ensure(GrillBlockEntity grill) {
        ...
        ACTIVE.computeIfAbsent(grill.getBlockPos(), pos -> {
    ...
    @Override public void tick() {
        ...
        if (level == null || !(level.getBlockEntity(pos) instanceof GrillBlockEntity grill)
                || !grill.getBlockState().getValue(GrillBlock.LIT) || grill.isEmpty()) {
            stop();
