...
public final class ModBlocks {
  ...
  public static final DeferredRegister<Block> BLOCKS =
      DeferredRegister.create(ForgeRegistries.BLOCKS, KaleidoscopeGrilling.MOD_ID);
  public static final RegistryObject<Block> GRILL =
      BLOCKS.register(
          "grill",
          () ->
              new GrillBlock(
                  BlockBehaviour.Properties.copy(Blocks.IRON_BARS)
                      ...
                      .noOcclusion()));
  public static final RegistryObject<Block> SEASONING_BOTTLE =
      BLOCKS.register(
          "seasoning_bottle",
          () ->
              new SeasoningBottleBlock(
                  BlockBehaviour.Properties.copy(Blocks.GLASS)
                      ...
                      .instabreak()
                      .noOcclusion()));
  public static final RegistryObject<Block> BIG_VAT =
      BLOCKS.register(
          "big_vat",
          () ->
              new BigVatBlock(
                  BlockBehaviour.Properties.copy(Blocks.BRICKS).strength(2.0F).noOcclusion()));
  public static final RegistryObject<Block> OIL_PRESS =
      BLOCKS.register(
          "oil_press",
          () ->
              new OilPressBlock(
                  BlockBehaviour.Properties.copy(Blocks.OAK_PLANKS).strength(2.5F).noOcclusion()));
  public static final RegistryObject<Block> ADVANCED_RACK =
      BLOCKS.register(
          "advanced_rack",
          () ->
              new AdvancedRackBlock(
                  BlockBehaviour.Properties.copy(Blocks.OAK_SLAB).strength(2.0F).noOcclusion()));
  public static final RegistryObject<Block> SKEWER_RECIPE =
      BLOCKS.register(
          "skewer_recipe",
          () ->
              new SkewerRecipeBlock(
                  BlockBehaviour.Properties.copy(Blocks.WHITE_WOOL).instabreak().noOcclusion()));
  public static final RegistryObject<Block> SKEWER_PLATE =
      BLOCKS.register(
          "skewer_plate",
          () ->
              new SkewerPlateBlock(
                  BlockBehaviour.Properties.copy(Blocks.OAK_PRESSURE_PLATE)
                      .instabreak()
                      .noOcclusion()));
  public static final RegistryObject<Block> CANOLA_CROP =
      BLOCKS.register(
          "canola_crop",
          () ->
              new CanolaCropBlock(
          ...
          () ->
              new OnionCropBlock(
                  BlockBehaviour.Properties.copy(Blocks.WHEAT)
                      ...
                      .instabreak()
                      .noOcclusion()));
  public static final RegistryObject<Block> SWEET_POTATO_CROP =
      BLOCKS.register(
          "sweet_potato_crop",
          () ->
              new SweetPotatoCropBlock(
                  BlockBehaviour.Properties.copy(Blocks.BEETROOTS)
                      ...
                      .instabreak()
                      .noOcclusion()));
  public static final RegistryObject<Block> HOUTTUYNIA_CROP =
      BLOCKS.register(
          "houttuynia_crop",
          () ->
              new HouttuyniaCropBlock(
                  BlockBehaviour.Properties.copy(Blocks.NETHER_WART)
                      .noCollission()
                      .randomTicks()
                      .instabreak()
                      .noOcclusion()));
  public static final RegistryObject<Block> PEPPER_LOG =
      BLOCKS.register("pepper_log", PepperLogBlock::new);
  public static final RegistryObject<Block> PEPPER_LEAVES =
      BLOCKS.register("pepper_leaves", PepperLeavesBlock::new);
  public static final RegistryObject<Block> PEPPER_SAPLING =
      BLOCKS.register("pepper_sapling", PepperSaplingBlock::new);
  public static final RegistryObject<Item> PEPPER_LOG_ITEM =
      ModItems.ITEMS.register(
          "pepper_log", () -> new BlockItem(PEPPER_LOG.get(), new Item.Properties()));
  public static final RegistryObject<Item> PEPPER_LEAVES_ITEM =
      ModItems.ITEMS.register(
          "pepper_leaves", () -> new BlockItem(PEPPER_LEAVES.get(), new Item.Properties()));
  public static final RegistryObject<Item> PEPPER_SAPLING_ITEM =
      ModItems.ITEMS.register(
      ...
      ModItems.ITEMS.register(
          ...
          () ->
              new FunctionalBlockItem(
                  ...
                  null));
  public static final RegistryObject<Item> BIG_VAT_ITEM =
      ModItems.ITEMS.register(
          "big_vat",
          () ->
              new FunctionalBlockItem(
  ...
  public static final RegistryObject<Item> OIL_PRESS_ITEM =
      ModItems.ITEMS.register(
          "oil_press",
          () ->
              new FunctionalBlockItem(
  ...
  public static final RegistryObject<Item> ADVANCED_RACK_ITEM =
      ModItems.ITEMS.register(
          "advanced_rack",
