...
public final class FoodState {
    ...
    public static void setHot(ItemStack s, long until) { s.getOrCreateTag().putLong(HOT_UNTIL, until); }

    public static boolean isHot(ItemStack s, Level l) { return s.hasTag() && s.getTag().getLong(HOT_UNTIL) > l.getGameTime(); }
