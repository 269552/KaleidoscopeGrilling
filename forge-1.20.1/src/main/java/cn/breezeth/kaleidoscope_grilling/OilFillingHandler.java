...
public final class OilFillingHandler {
    ...
    public static void onRightClickBlock(PlayerInteractEvent.RightClickBlock event) {
        ...
        String type = type(bucket);
        var id = net.minecraftforge.registries.ForgeRegistries.BLOCKS.getKey(event.getLevel().getBlockState(event.getPos()).getBlock());
        if (type == null || id == null || !id.toString().equals("kaleidoscope_cookery:oil_pot")
