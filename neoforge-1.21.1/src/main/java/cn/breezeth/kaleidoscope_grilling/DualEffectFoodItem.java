...
public final class DualEffectFoodItem extends Item {
    ...
    public DualEffectFoodItem(Properties properties, ResourceLocation firstEffect, int firstDuration,
                              ResourceLocation secondEffect, int secondDuration, String tooltip) {
        super(properties);
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> lines, TooltipFlag flag) {
        ...
        FoodTooltip.appendEffects(lines, context, firstEffect, firstDuration, secondEffect, secondDuration);
    }
}
