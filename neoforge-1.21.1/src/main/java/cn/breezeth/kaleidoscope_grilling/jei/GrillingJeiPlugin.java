...
public final class GrillingJeiPlugin implements IModPlugin {
  private static final ResourceLocation ID =
      ResourceLocation.fromNamespaceAndPath(KaleidoscopeGrilling.MOD_ID, "jei_plugin");
  ...
  public void registerItemSubtypes(ISubtypeRegistration registration) {
    ...
    IIngredientSubtypeInterpreter<net.minecraft.world.item.ItemStack> interpreter =
        (stack, context) -> OilPotCompat.jeiSubtype(stack);
    registration.registerSubtypeInterpreter(pots.get(0).getItem(), interpreter);
  }
  ...
  public void registerVanillaCategoryExtensions(
    ...
    registration
        .getCraftingCategory()
        .addExtension(SkewerRecipeCraftingRecipe.class, new SkewerRecipeJeiExtension());
    registration
        .getCraftingCategory()
