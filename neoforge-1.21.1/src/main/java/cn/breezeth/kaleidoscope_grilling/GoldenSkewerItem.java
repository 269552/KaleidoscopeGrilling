...
public final class GoldenSkewerItem extends SkewerItem {
  public GoldenSkewerItem(Properties properties) {
    super(properties, "tooltip.kaleidoscope_grilling.grilled_golden_skewer.maxim", ResourceLocation.fromNamespaceAndPath(KaleidoscopeGrilling.MOD_ID, "invincible"), 200);
  }
