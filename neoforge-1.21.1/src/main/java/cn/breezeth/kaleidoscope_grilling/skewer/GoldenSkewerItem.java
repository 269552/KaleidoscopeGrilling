...
public final class GoldenSkewerItem extends MultiBiteSkewerItem {
  public GoldenSkewerItem(Properties properties) {
    super(properties, "tooltip.kaleidoscope_grilling.grilled_golden_skewer.maxim", ResourceLocation.fromNamespaceAndPath(KaleidoscopeGrilling.MOD_ID, "invincible"), 200, AnimationProfile.THREE_RANDOM);
  }
