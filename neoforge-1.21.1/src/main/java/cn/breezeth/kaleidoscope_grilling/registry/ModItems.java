...
import cn.breezeth.kaleidoscope_grilling.food.WeddingCandyItem;
...
public final class ModItems {
  public static final DeferredRegister<Item> ITEMS =
      DeferredRegister.create(BuiltInRegistries.ITEM, KaleidoscopeGrilling.MOD_ID);
  ...
  public static final DeferredHolder<Item, Item> UNFINISHED_SKEWER =
      ITEMS.register("unfinished_skewer", () -> new UnfinishedSkewerItem(new Item.Properties()));
  public static final DeferredHolder<Item, Item> SKEWER_RECIPE_BOOK =
      ITEMS.register(
          "skewer_recipe_book", () -> new SkewerRecipeBookItem(new Item.Properties().stacksTo(1)));
  public static final DeferredHolder<Item, Item> SECRET_SKEWER =
      ITEMS.register(
          "secret_skewer",
          () ->
                  ...
                  new Item.Properties()
                      ...
                      .food(
                          new FoodProperties.Builder()
                              ...
                              .build())));
  public static final DeferredHolder<Item, Item> SKEWER_PLATE =
      ITEMS.register(
          "skewer_plate",
          () ->
              new SkewerPlateItem(
                  new Item.Properties()
                      ...
                      .food(
                          new FoodProperties.Builder()
                              ...
                              .saturationModifier(0)
                              .build())));
  public static final DeferredHolder<Item, Item> CANOLA_OIL_BRUSH =
      ITEMS.register(
          "canola_oil_brush",
          () ->
              new DescriptionItem(
  ...
  public static final DeferredHolder<Item, Item> SECRET_CHILI_OIL_BRUSH =
      ITEMS.register(
          ...
          () ->
              new DescriptionItem(
                  new Item.Properties().stacksTo(1),
                  "tooltip.kaleidoscope_grilling.oil_brush.unobtainable"));
  public static final DeferredHolder<Item, Item> PREMIUM_CHILI_OIL_BRUSH =
      ITEMS.register(
  ...
  public static final DeferredHolder<Item, Item> CHICKEN_WING =
      ingredient(
          "chicken_wing",
          () ->
              new Item(
  ...
  public static final DeferredHolder<Item, Item> HOUTTUYNIA =
      ingredient(
          "houttuynia",
          () ->
                  ...
                  new Item.Properties()
                      .food(
                          new FoodProperties.Builder()
                              ...
                              .build())));
  public static final DeferredHolder<Item, Item> MINCED_HOUTTUYNIA =
      ingredient("minced_houttuynia");
  public static final DeferredHolder<Item, Item> CARROT_DICE = ingredient("carrot_dice");
  public static final DeferredHolder<Item, Item> RAW_SWEET_POTATO_SHEET =
      ingredient(
  ...
  public static final DeferredHolder<Item, Item> MYSTERIOUS_SKEWER =
      ITEMS.register(
          "mysterious_skewer",
          () ->
              new MultiBiteSkewerItem(
                  ...
                  100,
                  MultiBiteSkewerItem.AnimationProfile.THREE_RANDOM));
  public static final DeferredHolder<Item, Item> DARK_GRILLING =
      ITEMS.register(
          "dark_grilling",
          () ->
              new MultiBiteSkewerItem(
                  ...
                  200,
                  MultiBiteSkewerItem.AnimationProfile.THREE_RANDOM));
  public static final DeferredHolder<Item, Item> EMPTY_SEASONING_BOTTLE =
      ITEMS.register(
          "empty_seasoning_bottle",
          () ->
              new SeasoningBottleBlockItem(
                  ModBlocks.SEASONING_BOTTLE.get(), new Item.Properties().stacksTo(1)));
  public static final DeferredHolder<Item, Item> PENDING_SEASONING =
      ITEMS.register(
          "pending_seasoning",
          () ->
              new PendingSeasoningItem(
                  ModBlocks.SEASONING_BOTTLE.get(), new Item.Properties().stacksTo(1)));
  public static final DeferredHolder<Item, Item> SPECIAL_SEASONING =
      ITEMS.register(
          "special_seasoning",
          () ->
              new SeasoningItem(
                  ...
                  new Item.Properties().stacksTo(1)));
  public static final DeferredHolder<Item, Item> GREEN_CHILI_POWDER =
      ingredient("green_chili_powder");
  public static final DeferredHolder<Item, Item> SICHUAN_PEPPER =
      ingredient(
          "sichuan_pepper",
          () ->
              new EffectFoodItem(
  ...
  public static final DeferredHolder<Item, Item> HOUTTUYNIA_POWDER =
      ingredient("houttuynia_powder");
  public static final DeferredHolder<Item, Item> TOTEM_POWDER = ingredient("totem_powder");
  public static final DeferredHolder<Item, Item> DRAGON_EGG_POWDER =
      ingredient("dragon_egg_powder");
  public static final DeferredHolder<Item, Item> OIL_CAKE = ingredient("oil_cake");
  public static final DeferredHolder<Item, Item> OIL_RESIDUE =
  ...
  public static final DeferredHolder<Item, Item> ONION =
      ingredient(
          "onion", () -> new ItemNameBlockItem(ModBlocks.ONION_CROP.get(), new Item.Properties()));
  public static final DeferredHolder<Item, Item> SWEET_POTATO =
      ITEMS.register(
          "sweet_potato",
          () ->
              new ItemNameBlockItem(
                  ...
                  new Item.Properties()
                      .food(
                          new FoodProperties.Builder()
                              ...
                              .build())));
  public static final DeferredHolder<Item, Item> ROASTED_SWEET_POTATO =
      ITEMS.register(
  ...
  public static final DeferredHolder<Item, Item> SWEET_POTATO_POWDER =
      ITEMS.register("sweet_potato_powder", () -> new SweetPotatoPowderItem(new Item.Properties()));
  public static final DeferredHolder<Item, Item> ROASTED_CHICKEN_WING =
      ITEMS.register(
  ...
  public static final DeferredHolder<Item, Item> COLD_HOUTTUYNIA =
      ITEMS.register(
          "cold_houttuynia",
          () ->
              new EffectFoodItem(
  ...
  public static final DeferredHolder<Item, Item> SUGARED_TOMATO =
      ITEMS.register(
          "sugared_tomato",
          () ->
              new FlavorFoodItem(
  ...
  public static final DeferredHolder<Item, Item> PEPPER_HONEY =
      ITEMS.register(
          "pepper_honey",
          () ->
              new EffectFoodItem(
  ...
  public static final DeferredHolder<Item, Item> WEDDING_CANDY =
      ITEMS.register(
          "wedding_candy",
          () ->
              new WeddingCandyItem(
                  new Item.Properties()
                      .food(
                          new FoodProperties.Builder()
                              .nutrition(20)
                              ...
                              .alwaysEdible()
                              .build()),
                  grillingEffect("invincible")));
  public static final DeferredHolder<Item, Item> HOUTTUYNIA_STIR_FRIED_PORK =
      dish("houttuynia_stir_fried_pork", 9, 0.7F);
  public static final DeferredHolder<Item, Item> GREEN_PEPPER_SQUID_TENTACLES =
      dish("green_pepper_squid_tentacles", 8, 0.6F);
  public static final DeferredHolder<Item, Item> BRAISED_CHICKEN_WINGS =
      dish("braised_chicken_wings", 10, 0.8F);
  public static final DeferredHolder<Item, Item> POTATO_BEEF_STEW =
      dish("potato_beef_stew", 12, 0.9F);
  public static final DeferredHolder<Item, Item> RED_SWEET_POTATO_PORRIDGE =
      ITEMS.register(
  ...
  public static final DeferredHolder<Item, Item> CANOLA_SEEDS =
      ITEMS.register(
          "canola_seeds",
          () -> new ItemNameBlockItem(ModBlocks.CANOLA_CROP.get(), new Item.Properties()));
  public static final DeferredHolder<Item, Item> CANOLA_OIL_BUCKET =
      ITEMS.register(
          "canola_oil_bucket",
          () ->
              new net.minecraft.world.item.BucketItem(
                  ModFluids.CANOLA_SOURCE.get(), new Item.Properties().stacksTo(1)));
  public static final DeferredHolder<Item, Item> SECRET_CHILI_OIL_BUCKET =
      ITEMS.register(
          "secret_chili_oil_bucket",
          () ->
              new net.minecraft.world.item.BucketItem(
                  ModFluids.SECRET_SOURCE.get(), new Item.Properties().stacksTo(1)));
  public static final DeferredHolder<Item, Item> PREMIUM_CHILI_OIL_BUCKET =
      ITEMS.register(
          "premium_chili_oil_bucket",
          () ->
              new net.minecraft.world.item.BucketItem(
                  ModFluids.PREMIUM_SOURCE.get(),
                  new Item.Properties()
                      .stacksTo(1)
                      .craftRemainder(net.minecraft.world.item.Items.BUCKET)));
  public static final DeferredHolder<Item, Item> RAW_LAMB_SKEWER =
      ITEMS.register(
          "raw_lamb_skewer",
          () ->
              new MultiBiteSkewerItem(
                  ...
                  0,
                  MultiBiteSkewerItem.AnimationProfile.THREE_RANDOM));
  public static final DeferredHolder<Item, Item> GRILLED_LAMB_SKEWER =
      ITEMS.register(
          "grilled_lamb_skewer",
          () ->
              new MultiBiteSkewerItem(
                  ...
                  45 * 20,
                  MultiBiteSkewerItem.AnimationProfile.THREE_RANDOM));
  public static final DeferredHolder<Item, Item> RAW_GOLDEN_SKEWER =
      ITEMS.register(
          "raw_golden_skewer",
          () ->
              new MultiBiteSkewerItem(
                  ...
                  0,
                  MultiBiteSkewerItem.AnimationProfile.THREE_RANDOM));
  public static final DeferredHolder<Item, Item> GRILLED_GOLDEN_SKEWER =
      ITEMS.register(
                  ...
                  new Item.Properties()
                      .food(
                          new FoodProperties.Builder()
                              ...
                              .saturationModifier(1.2F)
                              .build())));
  public static final DeferredHolder<Item, Item> ORDINARY_SKEWER =
      ITEMS.register(
          "ordinary_skewer",
          () ->
              new CursedSkewerItem(
                  new Item.Properties()
                      .food(
                          new FoodProperties.Builder()
                              .nutrition(5)
                              .saturationModifier(0.46F)
                              .alwaysEdible()
                              .build())));
  public static final DeferredHolder<Item, Item> SOUR_SPICY_NOODLES =
      ITEMS.register(
          "sour_spicy_noodles",
          () ->
              new EffectFoodItem(
  ...
  static {
    multiBiteSkewer(
        ...
        10,
        MultiBiteSkewerItem.AnimationProfile.FOUR);
    ...
    multiBiteSkewer(
        ...
        5,
        0.4F,
        ResourceLocation.withDefaultNamespace("water_breathing"),
        30,
        MultiBiteSkewerItem.AnimationProfile.THREE_RANDOM);
  ...
  private static DeferredHolder<Item, Item> ingredient(
      String id, Supplier<? extends Item> factory) {
    DeferredHolder<Item, Item> item = ITEMS.register(id, factory);
    INGREDIENTS.add(item);
    return item;
  }

  private static DeferredHolder<Item, Item> dish(String id, int nutrition, float saturation) {
  ...
  private static void rawSkewer(
    ...
    FoodProperties.Builder food =
        new FoodProperties.Builder().nutrition(nutrition).saturationModifier(saturationModifier);
    RAW_SKEWERS.add(
        ITEMS.register(
            id,
            () ->
                new MultiBiteSkewerItem(
                    ...
                    null,
                    nausea ? ResourceLocation.withDefaultNamespace("nausea") : null,
                    nausea ? 60 : 0,
                    animationProfile(id))));
  }
  ...
  private static MultiBiteSkewerItem.AnimationProfile animationProfile(String id) {
    String name = id.replace("raw_", "").replace("grilled_", "");
    if (name.equals("fish_skewer") || name.equals("caterpillar_skewer"))
      return MultiBiteSkewerItem.AnimationProfile.ONE;
    if (name.equals("bun_slice_skewer")
        || name.equals("fried_egg_skewer")
        || name.equals("slime_skewer")
        || name.equals("sweet_potato_sheet_skewer"))
      return MultiBiteSkewerItem.AnimationProfile.TWO;
    if (name.equals("beef_skewer")
        || name.equals("chicken_skin_skewer")
        || name.equals("pork_belly_skewer"))
      return MultiBiteSkewerItem.AnimationProfile.FOUR;
    if (name.equals("ender_pearl_skewer")) return MultiBiteSkewerItem.AnimationProfile.THREE;
    return MultiBiteSkewerItem.AnimationProfile.THREE_RANDOM;
  }
