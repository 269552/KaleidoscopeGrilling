...
public final class GrillingKubeJSBindings {
  private static final ResourceLocation GENERATED_COOKED =
      ResourceLocation.fromNamespaceAndPath("kaleidoscope_grilling", "secret_skewer");
  ...
  public static void threadingRecipe(String id, String result, String[] ingredients) {
    GrillingDataManager.registerThreadingRecipe(
        parseId(id, "id"), parseSlots(ingredients), parseId(result, "result"));
  }
  ...
  public static void skewerRecipe(
    ...
    GrillingDataManager.registerSkewerRecipe(
        parseId(raw, "raw result"),
        parseId(cooked, "cooked result"),
  ...
  public static void cookingRecipe(String raw, String cooked, Map<String, Object> options) {
    cookingRecipe(raw, cooked, new String[0], options);
  }

  public static void cookingRecipe(String raw, String cooked, String[] displayIngredients) {
