...
enum TypedOilPotProvider implements IBlockComponentProvider {
    ...
    public void appendTooltip(ITooltip tooltip, BlockAccessor accessor, IPluginConfig config) {
        ...
        tooltip.add(Component.translatable("jade.kaleidoscope_grilling.oil_pot." + type,
                oil.grilling$getOilCount()), GrillingJadePlugin.OIL_POT);
    }
    ...
    @Override public ResourceLocation getUid() { return GrillingJadePlugin.OIL_POT; }
}
