...
enum SkewerPlateProvider implements IBlockComponentProvider {
  ...
  public void appendTooltip(ITooltip tooltip, BlockAccessor accessor, IPluginConfig config) {
    ...
    if (!skewers.isEmpty())
      tooltip.add(Component.translatable("jade.kaleidoscope_grilling.skewer_plate.pack"));
  }

  @Override
  public ResourceLocation getUid() {
    return ResourceLocation.fromNamespaceAndPath(KaleidoscopeGrilling.MOD_ID, "skewer_plate");
  }
}
