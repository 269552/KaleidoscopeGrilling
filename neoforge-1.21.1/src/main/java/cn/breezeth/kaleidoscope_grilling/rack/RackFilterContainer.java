...
final class RackFilterContainer implements Container {
  ...
  public int getContainerSize() {
    return AdvancedRackBlockEntity.COMPARTMENT_COUNT;
  }

  @Override
  public boolean isEmpty() {
    for (int i = 0; i < getContainerSize(); i++) if (!rack.getFilter(i).isEmpty()) return false;
    return true;
  }
  ...
  public void clearContent() {
    for (int i = 0; i < getContainerSize(); i++) rack.clearFilter(i);
  }
