...
public final class SkewerRecipeCraftingRecipe extends CustomRecipe {
    private static final TagKey<net.minecraft.world.item.Item> RAW_SKEWERS = TagKey.create(
            Registries.ITEM, ResourceLocation.fromNamespaceAndPath(KaleidoscopeGrilling.MOD_ID, "raw_skewers"));
    ...
    @Override public RecipeSerializer<?> getSerializer() { return ModRecipeSerializers.SKEWER_RECIPE_BOOK.get(); }
