...
public final class ModBlocks {
    ...
    public static final DeferredHolder<Block, Block> GRILL = BLOCKS.register("grill", () -> new GrillBlock(
            BlockBehaviour.Properties.ofFullCopy(Blocks.IRON_BARS).sound(COOKERY_POT_SOUND).strength(3.0F).lightLevel(s->s.getValue(GrillBlock.LIT)?7:0).noOcclusion()));
    ...
    public static final DeferredHolder<Item, Item> OIL_PRESS_ITEM = ModItems.ITEMS.register("oil_press",
