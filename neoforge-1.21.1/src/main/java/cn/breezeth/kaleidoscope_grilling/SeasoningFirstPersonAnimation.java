...
public final class SeasoningFirstPersonAnimation {
    ...
    public static void render(RenderHandEvent event) {
        ...
        minecraft.getItemRenderer().renderStatic(stack, context, event.getPackedLight(),
                OverlayTexture.NO_OVERLAY, pose, event.getMultiBufferSource(), minecraft.level, player.getId());
        pose.popPose();
    }
