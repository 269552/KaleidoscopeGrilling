...
public final class OilPotHud {
    ...
    public static void render(RenderGuiLayerEvent.Post event) {
        ...
        if (minecraft.level == null || minecraft.options.hideGui
                ...
                || !(minecraft.level.getBlockEntity(hit.getBlockPos()) instanceof TypedOilPotAccess oil)) return;
    ...
    private static void draw(GuiGraphics graphics, TypedOilPotAccess oil) {
        ...
        graphics.drawString(minecraft.font, Component.translatable("hud.kaleidoscope_grilling.oil_pot.title"), x + 12, y + 9, 0xFFF3E9D2, false);
        graphics.drawString(minecraft.font, Component.translatable("tooltip.kaleidoscope_grilling.oil_pot." + state, count), x + 12, y + 23, 0xFFE5E8E8, false);
        graphics.drawString(minecraft.font, Component.translatable("hud.kaleidoscope_grilling.oil_pot.capacity", count, 64, 64 - count), x + 12, y + 36, 0xFFAAB7B8, false);
