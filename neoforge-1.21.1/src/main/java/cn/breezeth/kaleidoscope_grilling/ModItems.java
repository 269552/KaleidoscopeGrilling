...
public final class ModItems {
    ...
    public static final DeferredHolder<Item, Item> SECRET_SKEWER = ITEMS.register("secret_skewer", () -> new SecretSkewerItem(
            new Item.Properties().stacksTo(1).food(new FoodProperties.Builder().nutrition(1).saturationModifier(0).build())));
    public static final DeferredHolder<Item, Item> SKEWER_PLATE = ITEMS.register("skewer_plate", () -> new SkewerPlateItem(
            new Item.Properties().stacksTo(1).food(new FoodProperties.Builder().nutrition(1).saturationModifier(0).build())));
    public static final DeferredHolder<Item, Item> CANOLA_OIL_BRUSH = ITEMS.register("canola_oil_brush", () -> new DescriptionItem(new Item.Properties().stacksTo(1), "tooltip.kaleidoscope_grilling.oil_brush.unobtainable"));
    public static final DeferredHolder<Item, Item> SECRET_CHILI_OIL_BRUSH = ITEMS.register("secret_chili_oil_brush", () -> new DescriptionItem(new Item.Properties().stacksTo(1), "tooltip.kaleidoscope_grilling.oil_brush.unobtainable"));
    public static final DeferredHolder<Item, Item> PREMIUM_CHILI_OIL_BRUSH = ITEMS.register("premium_chili_oil_brush", () -> new DescriptionItem(new Item.Properties().stacksTo(1), "tooltip.kaleidoscope_grilling.oil_brush.unobtainable"));
    ...
    public static final DeferredHolder<Item, Item> RAW_SWEET_POTATO_SHEET = ingredient("raw_sweet_potato_sheet", () -> new RawSweetPotatoSheetItem(new Item.Properties()));
    ...
    public static final DeferredHolder<Item, Item> PENDING_SEASONING = ITEMS.register("pending_seasoning", () -> new PendingSeasoningItem(ModBlocks.SEASONING_BOTTLE.get(), new Item.Properties().stacksTo(1)));
    public static final DeferredHolder<Item, Item> SPECIAL_SEASONING = ITEMS.register("special_seasoning", () -> new SeasoningItem(ModBlocks.SEASONING_BOTTLE.get(), new Item.Properties().stacksTo(1).durability(16)));
    ...
    public static final DeferredHolder<Item, Item> OIL_RESIDUE = ingredient("oil_residue", () -> new OilResidueItem(new Item.Properties()));
    ...
    public static final DeferredHolder<Item, Item> ONION = ingredient("onion",()->new ItemNameBlockItem(ModBlocks.ONION_CROP.get(),new Item.Properties()));
    ...
    public static final DeferredHolder<Item, Item> HOUTTUYNIA_STIR_FRIED_PORK = dish("houttuynia_stir_fried_pork", 9, 0.7F);
    public static final DeferredHolder<Item, Item> GREEN_PEPPER_SQUID_TENTACLES = dish("green_pepper_squid_tentacles", 8, 0.6F);
    public static final DeferredHolder<Item, Item> BRAISED_CHICKEN_WINGS = dish("braised_chicken_wings", 10, 0.8F);
    public static final DeferredHolder<Item, Item> POTATO_BEEF_STEW = dish("potato_beef_stew", 12, 0.9F);
    public static final DeferredHolder<Item, Item> RED_SWEET_POTATO_PORRIDGE = ITEMS.register("red_sweet_potato_porridge", () ->
            new DualEffectFoodItem(new Item.Properties().stacksTo(16).food(new FoodProperties.Builder()
                    .nutrition(14).saturationModifier(0.071429F).build()),
    ...
    public static final DeferredHolder<Item, Item> CANOLA_OIL_BUCKET = ITEMS.register("canola_oil_bucket", () -> new net.minecraft.world.item.BucketItem(ModFluids.CANOLA_SOURCE.get(), new Item.Properties().stacksTo(1)));
    public static final DeferredHolder<Item, Item> SECRET_CHILI_OIL_BUCKET = ITEMS.register("secret_chili_oil_bucket", () -> new net.minecraft.world.item.BucketItem(ModFluids.SECRET_SOURCE.get(), new Item.Properties().stacksTo(1)));
